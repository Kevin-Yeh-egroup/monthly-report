      ...
      workChallenges: [
        {
          ...
          details: [
            "將開發改至Cursor，降低幻覺並有迭代紀錄",
            "先使用Claude進行開發及設計，再轉換成vo版本"
          ]
        },
        {
          title: "小工具沒有測試",
          ...
          details: [
            "詢問同仁需求並優先開發，請夥伴所有小工具一起測試。",
            "每週回報James及Ivy測試及修正狀況。"
          ]
        },
        {
          ...
          details: [
            "James審核後，就馬上加入書籤上架文章",
            "由先博整理好理家在知識庫補充計畫(第二輪進行中)，列出文章標題即包含知識點，由先博及工讀生用Claude及ChatGPT o3進行爬蟲及文章生成，最後由先博檢查並用AI檢核。",
            "提醒小編，並定期回報狀況給Ivy及素菁"
          ]
        },
        {
          ...
          details: [
            "整理講者的講義，分析講綱整理架構，並且排序梳理脈絡。",
            "限於錄音逐字稿內容，補充主架構分支。",
            "限於整理的內容，以架構作為段落整理成文章，並確認易讀性、詞句流暢及邏輯合理性，避免冗言贅字及重複的內容。",
            "設計文章標題，檢查財務名詞及錯字。"
          ]
        },
        {
