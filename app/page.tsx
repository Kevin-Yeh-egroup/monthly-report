  ...
  useEffect(() => {
    ...
    const summary: MonthlySummary = {
      ...
      workChallenges: [
        {
          title: "小工具開發代數有限",
          description: "v0更改30次以上，常會有幻覺及設計會跑掉",
          details: [
            "1. 將開發改至Cursor，降低幻覺並有迭代紀錄",
            "2. 先使用Claude進行開發及設計，再轉換成vo版本"
          ]
        },
        {
          title: "小工具沒有測試",
          description: "工作流程缺失，未提醒夥伴進行測試並統整回饋",
          details: [
            "1. 詢問同仁需求並優先開發，請夥伴所有小工具一起測試。",
            "2. 每週回報James及Ivy測試及修正狀況。"
          ]
        },
        {
          title: "知識庫更新緩慢 文章數及知識涵蓋率低",
          description: "知識庫文章不足、更新不夠及時",
          details: [
            "1. James審核後，就馬上加入書籤上架文章",
            "2. 由先博整理好理家在知識庫補充計畫(第二輪進行中)，列出文章標題即包含知識點，由先博及工讀生用Claude及ChatGPT o3進行爬蟲及文章生成，最後由先博檢查並用AI檢核。",
            "3. 提醒小編，並定期回報狀況給Ivy及素菁"
          ]
        },
        {
          title: "文章整理單薄",
          description: "過度依賴摘要功能，撰寫的文章資訊整理過於片面，缺乏多角度的整理以及前後差異分析。",
          details: [
            "1. 整理講者的講義，分析講綱整理架構，並且排序梳理脈絡。",
            "2. 限於錄音逐字稿內容，補充主架構分支。",
            "3. 限於整理的內容，以架構作為段落整理成文章，並確認易讀性、詞句流暢及邏輯合理性，避免冗言贅字及重複的內容。",
            "4. 設計文章標題，檢查財務名詞及錯字。"
          ]
        },
        {
          title: "看到狀況未主動釐清工作內容並分工",
          description: "一開始沒有當責處理知識庫以及許願池回饋管理",
          details: [
            "1. 思考自己需當責的部分，並擬定計畫及建立機制",
            "2. 與合作夥伴進行討論及分工"
          ]
        }
      ],
